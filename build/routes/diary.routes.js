...
const diaryController = __importStar(require("../controllers/diary"));
const diary_1 = __importDefault(require("../validators/diary"));
...
router.post('/', (req, res) => {
    try {
        const newDiaryEntry = (0, diary_1.default)(req.body);
